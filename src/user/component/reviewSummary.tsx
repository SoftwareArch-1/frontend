...
export const ReviewSummary = (reviewsProps : {
  ...
  return (
    <section className="flex flex-row h-[127px] w-[350px] relative items-center bg-white p-6 rounded-lg drop-shadow-md">
      <div className='pl-7 text-4xl'>
        <b>
          4.0
        </b>
      </div>
      <ul className="flex flex-col gap-2 absolute right-0 pr-14">
